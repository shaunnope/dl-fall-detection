...
# Retrieved 17/03/2024 from https://github.com/ultralytics/yolov5/tree/master/utils
"""Loss functions."""
import math
...
class ComputeLoss:
  ...
  # Compute losses
  def __init__(self, model, autobalance=False, cls_pw=1.0, obj_pw=1.0, iou_t=0.20, fl_gamma=0.0, label_smoothing=0.0):
    """Initializes ComputeLoss with model and autobalance option, autobalances losses if True."""
    device = next(model.parameters()).device  # get model device
    h = model.hyp  # hyperparameters
